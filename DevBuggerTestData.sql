...
exec createAccount @id,'deleteted-account@mail.com','[Deleted_account]','go342mjkojsdpkijgmkiWEENMGKwnghare','Deleted','Account', @outID1 output

exec createAccount @id,'test1@mail.com','test','Ml6YBKF5pYsjltNcFC9oSNTrPdjPqrfHVu6TKu8rm+0=','te','st', @outID2 output

exec createAccount @id,'test2@mail.com','test2','Ml6YBKF5pYsjltNcFC9oSNTrPdjPqrfHVu6TKu8rm+0=','te','st', @outID3 output

exec createAccount @id,'test3@mail.com','test3','Ml6YBKF5pYsjltNcFC9oSNTrPdjPqrfHVu6TKu8rm+0=','te','st', @outID4 output
